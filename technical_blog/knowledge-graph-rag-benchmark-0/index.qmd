...
The motivation behind this post is twofold, to run a basic knowledge graph *Retrieval Augmented Generation*(RAG) benchmark I can build off of and improve in future posts, and secondarily, to give the reader a ride-along of the process, from choosing a benchmark, creating a knowledge graph, connecting the knowledge graph to a vector store, and so forth. You are free to use the table of contents to skip around to what interests you most, or embark on a marathon read from top to bottom.
...
An [ever-growing survey](https://github.com/hymie122/RAG-Survey) of these techniques exists - and even that is not fully exhaustive. P.S. [exa.ai](exa.ai) is a fantastic source for research. ![](images/exaai.png)
